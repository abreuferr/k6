...
Description : Faz uma requisição de acesso a(s) credencial(is)
Options : 
*/

// Importa as funções do epmLibrary.js
import { getClientIDandClientSecret, getAccessToken, getCredentials } from './library/epmLibrary.js';
...
/*
k6 run k6_test_go/src/vaultShowCredencials.js --insecure-skip-tls-verify

k6 run --http-debug="full" k6_test_go/src/vaultShowCredencials.js --insecure-skip-tls-verify
*/